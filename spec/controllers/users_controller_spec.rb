...
describe UsersController do
  ...
  describe "for non-signed-in users" do
    ...
    describe "for signed-in users" do
      before(:each) do
        ...
        30.times do # create lots of users with diff email to test pagination
      ...
      it "should have an element for each user" do
        get :index
        @users[0..2].each do |user| # only test the elements for the users in the front to save time
  ...
  describe "GET 'edit' " do
    ...
    it "should have a link to change the Gravatar" do
      get :edit, :id => @user
      gravatar_url = "http://gravatar.com/emails" # the page to add or edit images is located at this url
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      it "should change the user's attributes" do
        put :update, :id => @user, :user => @attr
        @user.reload # reload used after changing the attributes of users
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      before(:each) do
        admin = Factory(:user, :email => "admin@example.com", :admin => true) #note: Factory is not bound by rule of attr_accessible params
        test_sign_in(admin)
      end
      it "should destroy the user" do
        lambda do
          delete :destroy, :id => @user
        end.should change(User,:count).by(-1) # by(-1) means delete one user
      end
